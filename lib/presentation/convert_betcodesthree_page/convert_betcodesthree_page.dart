import '../convert_betcodesthree_page/widgets/singleconversion1_item_widget.dart';
...
class ConvertBetcodesthreePage extends StatefulWidget {
  const ConvertBetcodesthreePage({Key? key}) : super(key: key);

  @override
  ConvertBetcodesthreePageState createState() =>
      ConvertBetcodesthreePageState();
}

// ignore_for_file: must_be_immutable
class ConvertBetcodesthreePageState extends State<ConvertBetcodesthreePage>
    with AutomaticKeepAliveClientMixin<ConvertBetcodesthreePage> {
    ...
    return Padding(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return Singleconversion1ItemWidget();
            }));
  }
